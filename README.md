# Seed your local and production database with real data
...
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/bmckay959/data-seeders/fix-php-code-style-issues.yml?branch=main&label=code%20style&style=flat-square)](https://github.com/bmckay959/data-seeders/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/data-seeders.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/data-seeders)
...
```bash
php artisan vendor:publish --tag="data-seeders-views"
```

## Usage

```php
$dataSeeders = new Bmckay959\DataSeeders();
echo $dataSeeders->echoPhrase('Hello, Bmckay959!');
```
